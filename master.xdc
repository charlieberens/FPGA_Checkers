...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { fake_clock }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz

#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets fake_cloc]
